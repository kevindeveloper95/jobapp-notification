...
def serviceName = "jobber-notification"
def service = "Jobber Notification"
...
pipeline {
  ...
  environment {
    ...
    IMAGE_NAME = "kevin1208" + "/" + "jobber-notification"
  ...
  stages {
    ...
    stage("Prepare Environment") {
      steps {
        ...
        // Add your notification service url to url field
        git branch: 'master', credentialsId: 'github', url: 'https://github.com/kevindeveloper95/jobapp-notification'
        script {
